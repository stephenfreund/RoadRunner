...
public class XSLTBench {
  ...
  public XSLTBench(File scratch) throws Exception {
    ...
    // Must specify class Loader for RR.  Otherwise it will be unable
    //  to find the transformer...
    TransformerFactory factory = TransformerFactory.newInstance("org.apache.xalan.processor.TransformerFactoryImpl", XalanWorker.class.getClassLoader());
    // Original: TransformerFactory factory = TransformerFactory.newInstance();
